...
class TaxonomyParser:
    ...
    def __init__(self, fname, level_prefix = "L"):
        self.prefix = level_prefix
        self.nodes = {}
        self.root_key = None
        self.fname = fname
        self.read_from_json(self.fname)
    ...
    def get_class_id(self, name) -> str:
        """
        Retrieve id param of node by its name
        ...
        Returns
        -------
        id: unique ID of the given node
        """
    ...
    def get_class_parent(self, name) -> [str, str]:
        """
        Retrieve id param of the parent node by its name
        ...
        Returns
        -------
        id: unique ID and name of the given node's parent
        """
        node = self.find_by_name(name)
        return node.parent.name ,node.parent.id
    ...
    def export(self, full=False):
        ...
        dot.to_dotfile(f"./h.dot")
        dot.to_picture(f"./h.png")
